...
<CardGroup cols={2}>
  <Card title="Train from scratch" icon="sparkles">
    Build and train your own GPT models on custom datasets
  </Card>
  <Card title="Finetune pretrained models" icon="wrench">
    Adapt GPT-2 checkpoints to your specific use case
  </Card>
  <Card title="Reproduce GPT-2" icon="clone">
    Recreate OpenAI's GPT-2 (124M) on OpenWebText
  </Card>
  <Card title="Experiment quickly" icon="flask">
